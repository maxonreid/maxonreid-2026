      ...
      <main className="min-h-screen" style={{ background: 'var(--bg-primary)' }}>
        ...
        <section className="pt-32 pb-0 w-[92%] max-w-[1200px] mx-auto">
          ...
          <div className="flex items-center gap-2 font-mono text-sm text-[#9ea0a8] mb-10">
            ...
            <span>/</span>
            <span className="text-[#d6b46b]">PM Real Estate Laos</span>
          </div>
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-[#e6e7ea] leading-none mb-6">
            PM Real Estate<span className="text-[#d6b46b]"> Laos</span>
          </h1>
          ...
          <div className="w-[92%] max-w-[1200px] mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {screenshotImages.map((img, i) => (
                <button
                  key={i}
                  className="group relative aspect-video rounded-xl overflow-hidden border border-white/[0.06] hover:border-[#d6b46b]/50 transition-all text-left bg-[#0a0a0c]"
          ...
          <div className="w-[92%] max-w-[1200px] mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_1fr] gap-12 mb-16">
              <div className="space-y-6">
                <h2 className="text-3xl font-bold text-[#e6e7ea]">{t('admin.heading')}</h2>
                <p className="text-[#9ea0a8] leading-relaxed">{t('admin.p1')}</p>
                <p className="text-[#9ea0a8] leading-relaxed">{t('admin.p2')}</p>
              </div>
            </div>
