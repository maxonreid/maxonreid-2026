...
export default function OrderBridgeArticle({
  locale,
  article,
}: {
  locale: string;
  ...
  const articleJsonLd = {
    ...
    about: {
      ...
      description: 'OAuth 2.0 middleware connecting delivery platforms to POS systems',
    },
  ...
  const faqJsonLd = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'What is OrderBridge?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'OrderBridge is an OAuth 2.0 middleware system that automatically connects food delivery platforms (DoorDash, Uber Eats, GrabFood) to restaurant POS systems, eliminating manual order entry.',
        },
      },
      {
        '@type': 'Question',
        name: 'How does OrderBridge handle security?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'OrderBridge uses OAuth 2.0 authentication with encrypted tokens, HMAC-SHA256 signature verification for webhooks, and automatic token refresh to maintain secure connections without exposing credentials.',
        },
      },
      {
        '@type': 'Question',
        name: 'What technologies power OrderBridge?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'OrderBridge is built with Node.js, TypeScript, Fastify framework, PostgreSQL for data persistence, WebSockets for real-time updates, and deployed on Railway and Vercel.',
        },
      },
      {
        '@type': 'Question',
        name: 'How much can OrderBridge save restaurants?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'By eliminating manual order entry, OrderBridge can save restaurants over $1,100 per month in labor costs for processing 50+ orders daily, while reducing errors and improving order accuracy.',
        },
      },
    ],
  };
  ...
  const softwareAppJsonLd = {
    ...
    operatingSystem: 'Web',
    description: 'OAuth 2.0 middleware connecting food delivery platforms to restaurant POS systems',
    offers: {
      '@type': 'Offer',
      price: '0',
      priceCurrency: 'USD',
